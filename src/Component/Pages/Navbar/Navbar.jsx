...
const Navbar = () => {
  ...
  const { currentUser, setLoading, signOutUser } = useProvider();
  ...
  return (
    <div
      className={
        scroll_counter >= 100
          ? "custom  fixed w-full z-40 navImg"
          : "fixed w-full z-40 custom2 navImg"
      }
    >
      <nav className="relative ">
        <div className="container-xl px-6 py-4 mx-auto md:flex md:justify-between md:items-center">
          <div className="flex items-center justify-between ">
            <a href="#">
              <img className="w-[40%] object-cover" src={companyLogo} alt="" />
            </a>
          ...
          >
            <div className="flex flex-col md:flex-row md:mx-6">
              ...
              <div
                ...
                className="border_li flex items-center gap-x-2 hover:bg-[#f3f3f5] transition-all px-1 py-2"
              >
                <span className="">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
              ...
              <div
                onClick={() => reloadHandlar()}
                className="border_li flex items-center md:justify-center p-2 gap-2 relative hover:bg-[#f3f3f5] transition-all md:hover:bg-none mb-2"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
              ...
              {currentUser?.uid ? (
                <div
                  ...
                  className="border_li flex items-center bg-[#DBE6F4] transition-all px-2 rounded-sm md:px-4 gap-2"
                >
                  <span className="">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                  ...
                  <button className="my-2 text-[#273c75] transition-colors duration-300 transform  hover:text-blue-500 dark:hover:text-blue-400 ">
                    Sign out
                  </button>
                </div>
              ) : (
                <div className="border_li flex items-center bg-[#DBE6F4] transition-all px-2 rounded-sm md:px-4 gap-2">
                  <span className="">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      fill="none"
