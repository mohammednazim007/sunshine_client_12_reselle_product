  ...
  return (
    <div>
      <div
        ...
        className="temp shadow-lg rounded-sm bg-white p-4 mx-auto"
      >
        <Link to={`/product/${data?.category}`}>
          <div className="relative">
            <img className="tempImg mx-auto" src={data?.image} alt="" />
            <img src="" alt="" />
            <h1 className="text-[#273c75] mt-3 text-xl font-semibold">
              {data?.name}
            </h1>
